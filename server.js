...
const defaultPartners = [
  ...
  { id: crypto.randomUUID(), name: 'Luma Lighting Studio', type: 'Lighting partner', description: 'Creative LED and decorative lighting solutions that bring every space to life.', location: 'Your City, India', whatsappUrl: 'https://wa.me/', createdAt: new Date().toISOString() },
  { id: crypto.randomUUID(), name: 'SunGrid Energy', type: 'Solar solutions', description: 'Reliable solar installation and energy-saving systems for homes and businesses.', location: 'Your City, India', whatsappUrl: 'https://wa.me/', createdAt: new Date().toISOString() }
];
